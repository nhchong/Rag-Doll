...
public class DogBackLeft extends BodyPart {
    ...
    DogBackLeft(float _width, float _height) {
    ...
    protected void initialize() {
        ...
        matrix.postRotate(25, anchorPointX, anchorPointY);
        this.rotationMatrix.postRotate(25, anchorPointX, anchorPointY);
    }
